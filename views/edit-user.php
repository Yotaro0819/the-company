...
<body>
   ...
   <nav class="navbar navbar-expand navbar-dark bg-dark" style="margin-bottom: 80px;">
      <div class="container">
        ...
        <!-- SEOのためにh1をつける。こうすることでgoogle、yahooがこれはタイトルだと認識できる。 -->
        ...
        <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
          <div class="row justify-content-center">
            ...
            <?php
                  ...
                  ?>
                  <!-- accept='image/*'は.png .jpg .jpeg .gifのみを許容する。他の.csv .pdfとかは除外する -->
                  <!-- accept='document/*'にすると.pdf .docx などのみを許容する。 -->
                  <!-- 特定の拡張子を指定したいときはaccept='png, jpg, jpeg'などと指定する -->
